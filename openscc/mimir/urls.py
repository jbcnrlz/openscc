...
urlpatterns = [    
     ...
     path('aluno/prova/<int:prova_aluno_id>/finalizar/', views.finalizarProva, name='finalizarProva'),
     path('aluno/prova/<int:prova_aluno_id>/resultado/', views.verResultadoProva, name='verResultadoProva'),
     path('professor/aplicacoes/', views.listarAplicacoesProva, name='listarAplicacoesProva'),
     path('professor/aplicacao/selecionar-prova/', views.selecionarProvaParaAplicacao, name='selecionarProvaParaAplicacao'),
     path('professor/aplicacao/criar/<int:prova_id>/', views.criarAplicacaoProva, name='criarAplicacaoProva'),
     path('professor/aplicacao/<int:aplicacao_id>/', views.detalhesAplicacaoProva, name='detalhesAplicacaoProva'),
     path('professor/aplicacao/<int:aplicacao_id>/editar/', views.editarAplicacaoProva, name='editarAplicacaoProva'),
     path('professor/aplicacao/<int:aplicacao_id>/excluir/', views.excluirAplicacaoProva, name='excluirAplicacaoProva'),
     path('professor/corrigir/<int:prova_aluno_id>/', views.corrigirProvaAluno, name='corrigirProvaAluno'),
     ...
     path('pergunta/<int:pergunta_id>/feedback/solicitar/', views.solicitarFeedbackPerguntaDireto, name='solicitarFeedbackPerguntaDireto')
]